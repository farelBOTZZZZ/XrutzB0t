...
fake = 'ZX.BOT'
numbernye = '0'
NamaOwner = 'Farel.SLEBEW'
NamaBot = 'Farel.BOT'

//owner number
const ownerNumber = ["6282150603552@s.whatsapp.net","6282150603552@s.whatsapp.net"]   //ganti nomor lu! 
...
DANA : 085790763534
GOPAY : 085790763534
YTChannel : https://youtube.com/channel/UCpsA_nCZZ87CIjM6JHoi3sg
...
//………………………………………………………ANIME MENU………………………………………………\\
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					zharzx.sendMessage(from, 'Pertanyaan : *'+sange+'*\n\nJawaban : '+ nge+'%', text, { quoted: mek })
					await limitAdd(sender)
					break
                    case 'gay':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					zharzx.sendMessage(from, 'Pertanyaan : *'+gayy+'*\n\nJawaban : '+ yag+'%', text, { quoted: mek })
					await limitAdd(sender)
					break
                    case 'lesbi':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					zharzx.sendMessage(from, 'Pertanyaan : *'+lesbii+'*\n\nJawaban : '+ bi+'%', text, { quoted: mek })
					await limitAdd(sender)
					break
				 case 'ngewe':
...
//.............………………………………………………FILM MENU………………………………………………………………\\
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					zharzx.updatePresence(from, Presence.composing) 
					data = await fetchJson(`https://api.lolhuman.xyz/api/filmapik?apikey=muzharzain&query=${body.slice(6)}`, {method: 'get'})
					teks = '=================\n'
					for (let i of data.result) {
						teks += `*Title:* : ${i.title}\n*Url* : ${i.url}\n=================\n`
					}
...
//……………………………………………………………………………NULIS MENU………………………………………………
			case 'nulis':
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                if (isBanned) return reply(ind.baned())
                if (args.length < 1) return reply(`Teksnya mana ngab?\nContoh ${prefix}nulis zharcthannel`)
                ct = body.slice(6)
                reply(ind.wait())
                asu = await getBuffer(`http://zekais-api.herokuapp.com/bukukanan?text=${ct}`)
                zharzx.sendMessage(from, asu, image, {caption: '*_NIHKAK JANGAN LUPA SUBS CHANNEL [https://youtube.com/channel/UCpsA_nCZZ87CIjM6JHoi3sg]_*', quoted: mek})
                break
				case 'nulis2':
                ...
                ct = body.slice(7)
                reply(ind.wait())
                asu = await getBuffer(`http://zekais-api.herokuapp.com/bukukiri?text=${ct}`)
                zharzx.sendMessage(from, asu, image, {caption: '*_NIHKAK JANGAN LUPA SUBS CHANNEL [https://youtube.com/channel/UCpsA_nCZZ87CIjM6JHoi3sg]_*', quoted: mek})
                break
                case 'nulis3':
                ...
                ct = body.slice(7)
                reply(ind.wait())
                asu = await getBuffer(`http://zekais-api.herokuapp.com/foliokanan?text=${ct}`)
                zharzx.sendMessage(from, asu, image, {caption: '*_NIHKAK JANGAN LUPA SUBS CHANNEL [https://youtube.com/channel/UCpsA_nCZZ87CIjM6JHoi3sg]_*', quoted: mek})
                break
                case 'nulis4':
                ...
                ct = body.slice(7)
                reply(ind.wait())
                asu = await getBuffer(`http://zekais-api.herokuapp.com/foliokiri?text=${ct}`)
                zharzx.sendMessage(from, asu, image, {caption: '*_NIHKAK JANGAN LUPA SUBS CHANNEL [https://youtube.com/channel/UCpsA_nCZZ87CIjM6JHoi3sg]_*', quoted: mek})
                break
                case 'telesticker':
                if (!isRegistered) return reply( ind.noregis())
				...
				reply(ind.wait())
                    ...
                    zharzx.sendMessage(from, ini_buffer, video, { quoted: mek })
                    break
                case 'tiktokmusic':
                if (!isRegistered) return reply( ind.noregis())
				if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				reply(ind.wait())
                    ...
                    zharzx.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: mek })
                    break
                    case 'igdl':
                if (!isRegistered) return reply( ind.noregis())
				if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				reply(ind.wait())
                    ...
                    ini_buffer = await getBuffer(ini_url)
                    zharzx.sendMessage(from, ini_buffer, ini_type, { quoted: mek })
                    break
                case 'fbdl':
                if (!isRegistered) return reply( ind.noregis())
				if (isLimit(sender)) return reply(ind.limitend(pusname))
